...
const disconnectFacebook = (0, catchAsync_1.default)(async (req, res) => {
    const result = await custom_auth_service_1.CustomAuthServices.disconnectFacebook(req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: result.message,
...
const disconnectInstagram = (0, catchAsync_1.default)(async (req, res) => {
    const result = await custom_auth_service_1.CustomAuthServices.disconnectInstagram(req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: result.message,
