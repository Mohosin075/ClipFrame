...
router
    .route('/create/:id')
    .post((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.CREATOR), (0, fileUploadHandler_1.default)(100, { preserveOriginalImages: true }), mediaUpload_1.handleMediaUpload, (0, validateRequest_1.default)(content_validation_1.ContentValidations.create), content_controller_1.ContentController.createContent);
...
router.post('/generate-caption', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.CREATOR), (0, validateRequest_1.default)(content_validation_1.ContentValidations.generateCaption), content_controller_1.ContentController.generateCaption);
