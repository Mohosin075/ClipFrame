...
router
    .route('/for-you')
    .get((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.CREATOR, user_1.USER_ROLES.USER), contenttemplate_controller_1.ContenttemplateController.getForYouTemplates);
// Base route: '/'
router
    .route('/')
    ...
    .post((0, auth_1.default)(user_1.USER_ROLES.ADMIN), (0, fileUploadHandler_1.default)(100), mediaUpload_1.handleMediaUpload, (0, validateRequest_1.default)(contenttemplate_validation_1.ContenttemplateValidations.create), contenttemplate_controller_1.ContenttemplateController.createContenttemplate);
...
router
    ...
    .patch((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.CREATOR, user_1.USER_ROLES.USER), (0, fileUploadHandler_1.default)(100), mediaUpload_1.handleMediaUpload, (0, validateRequest_1.default)(contenttemplate_validation_1.ContenttemplateValidations.update), contenttemplate_controller_1.ContenttemplateController.updateContenttemplate)
