...
const updateProfile = async (user, payload) => {
    ...
    if (payload.profile && isUserExist.profile) {
        try {
            ...
            logger_1.logger.error('Failed to delete old profile image from S3', error);
        }
    }
...
const getProfile = async (user) => {
    ...
    return {
        ...
        membership: (_d = (_c = subscriber === null || subscriber === void 0 ? void 0 : subscriber.planId) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : '',
