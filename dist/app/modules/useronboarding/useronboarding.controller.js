...
const getMyOnboarding = (0, catchAsync_1.default)(async (req, res) => {
    const result = await useronboarding_service_1.UseronboardingServices.getMyOnboarding(req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: 'Useronboarding retrieved successfully',
...
const updateMyOnboarding = (0, catchAsync_1.default)(async (req, res) => {
    const result = await useronboarding_service_1.UseronboardingServices.updateMyOnboarding(req.user, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
