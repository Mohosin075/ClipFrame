...
router.get('/my-onboarding', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.CREATOR), useronboarding_controller_1.UseronboardingController.getMyOnboarding);
router.patch('/update-my-onboarding', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.CREATOR), useronboarding_controller_1.UseronboardingController.updateMyOnboarding);
