...
router.get('/tiktok', async (req, res) => {
  ...
  const redirectUri =
    'https://pads-awareness-shot-incidents.trycloudflare.com/tiktok/callback'
  const scopes = 'user.info.basic,video.upload,video.publish'
  const state = '68b1fd9e3a485a0f4fc4b527'
  // https://www.tiktok.com/v2/auth/authorize?client_key=sbaw91u1ke2gdjjxhi&scope=user.info.basic,video.upload&response_type=code&redirect_uri=https://pads-awareness-shot-incidents.trycloudflare.com/tiktok/callback&state=68b1fd9e3a485a0f4fc4b527
